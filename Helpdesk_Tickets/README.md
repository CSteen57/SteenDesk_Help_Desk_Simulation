...
| [Ticket #003](./Tickets/Ticket003_User_Forgot_Password.md) | User forgot password | Account / Password Reset | Medium | In Progress |
| [Ticket #004](./Tickets/Ticket004_Workstation_Missing_Mapped_Drives.md) | New workstation missing mapped drives | Group Policy / Workstation OU | Medium | Planned |
| [Ticket #005](./Tickets/Ticket005_Approved_Software_Install.md) | User cannot install approved software | Workstation / Software Support | Low | Planned |d out / sign-in failure | Account / Authentication | Medium | Resolved |
